...
<head>
	...
	<title><?php echo $this->config->item('company') . ' | KIOTAZ ' . $this->config->item('application_version')  . ' | ' .  $this->lang->line('login_login'); ?></title>
...
<body>
    <div class="bg">
        <div id="logo" align="center"><img src="<?php echo base_url();?>images/logo.svg"></div>
    ...
    <?php $this->load->view('partial/3rd_party_services') ?>
</body>
</html>
